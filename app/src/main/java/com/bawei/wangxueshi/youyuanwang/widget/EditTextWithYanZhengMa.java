 ...
 * @time: 23:34
 */
public class EditTextWithYanZhengMa extends EditText {
    ...
    public EditTextWithYanZhengMa(Context context) {
        super(context);
        mContext = context;
        init();
    }

    public EditTextWithYanZhengMa(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mContext = context;
        init();
    }
    public EditTextWithYanZhengMa(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
